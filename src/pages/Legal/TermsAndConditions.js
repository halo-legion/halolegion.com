...
export default function TermsAndConditions() {
  return (
    <div className="terms-and-conditions">
      <h1 className="text-6xl font-inter text-primary my-4">
        Terms &amp; Conditions
      </h1>
      <p>
        ...
        other intellectual property rights related to it, still belong to DPS
        Indore.
      </p>{" "}
      <p>
        DPS Indore is committed to ensuring that the app is as useful and
      ...
      <p>
        The Halolegion app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the Halolegion app
      ...
      <p>
        You should be aware that there are certain things that DPS Indore will
        ...
        Wi-Fi, or provided by your mobile network provider, but DPS Indore
      ...
      <p>
        Along the same lines, DPS Indore cannot always take responsibility for
        ...
        avail the Service, DPS Indore cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to DPS Indore’s responsibility for your use of the app,
        ...
        make it available to you. DPS Indore accepts no liability for any loss,
      ...
      <p>
        ...
        to keep using the app. DPS Indore does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2020-11-28</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at halolegionofficial@gmail.com.
      </p>
    </div>
  );
}
