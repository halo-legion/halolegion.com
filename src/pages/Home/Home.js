        ...
        <section className="hero__bg">
          <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
            ...
            <div className="text-center lg:w-2/3 w-full">
              <h1 className="text-5xl sm:text-8xl mb-4 font-black text-primaryIndigo font-inter">
                Don't do it alone, do it with a legion, Halo.
              </h1>
              <div className="flex justify-center">
                <p className="my-6 break-words leading-relaxed text-lg font-medium font-display sm:w-1/2">
...
"
      ...
      <section
        id="team"
        className="team__section px-16 pt-12 pb-4 sm:px-32 sm:pt-24 sm:pb-20 my-20 bg-primary"
      >
